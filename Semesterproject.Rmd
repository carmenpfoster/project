...
ggplot(wildschwein_dailysummary, aes(x = season, y = daily_distance)) + 
  geom_boxplot()+
  labs(title = "Distance travelled per day", subtitle = "per wild boar")+
  ylab("distance [m]")
```
...
ggplot(wildschwein_dailysummary, aes(x=season, y = ratio))+
  geom_boxplot()+
  labs(title = "Share of static measurement points per day", subtitle = "per wild boar")+
  ylab("ratio")
```
...
ggplot(wildschwein_dailysummary, aes(x=temp, y=daily_distance, col = season)) + 
  ...
  labs(title = "Influence of temperature on the travelled distance per day", subtitle = "per season")+
  xlab("temperature [°C]")+
  ylab("distance [m]")
```
...
ggplot(wildschwein_dailysummary, aes(x=temp, y=ratio, col = season)) +
  geom_point(size=0.8)+
  geom_smooth(method=lm)+
  labs(title = "Influence of temperature on the share of static measurement points", subtitle = "per season")+
  xlab("temperature [°C]")+
  ylab("distance [m]")
```
...
ggplot(wildschwein_dailysummary, aes(x=temp, y=daily_distance, col = season)) +
  geom_point()+
  labs(title = "Influence of temperature on the travelled distance per day", subtitle = "per season for all wild boars seperately")+
  xlab("temperature [°C]")+
  ylab("distance [m]")+
...
ggplot(wildschwein_dailysummary, aes(x=precip, y=daily_distance, col = season)) + 
  ...
  labs(title = "Influence of precipitation on the travelled distance per day", subtitle = "per season")+
...
ggplot(wildschwein_dailysummary, aes(x=precip, y=ratio, col = season)) +
  geom_point(size=0.8)+
  geom_smooth(method=lm)+
  labs(title = "Influence of precipitation on the share of static measurement points", subtitle = "per season")+
  xlab("precipitation [mm]")+
  ylab("static ratio")
```
...
ggplot(wildschwein_dailysummary, aes(x=precip, y=daily_distance, col = season)) +
  geom_point()+
  labs(title = "Influence of precipitation on the travelled distance per day", subtitle = "per season for all wild boars seperately")+
  xlab("precipitation [mm]")+
  ylab("distance [m]")+
  facet_wrap(~TierName,labeller = label_value)
```
