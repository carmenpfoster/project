...
``` {r loading wildboar data, echo = TRUE, warning = FALSE, message = FALSE}
...
```{r assigning season, echo = FALSE, warning = FALSE, message = FALSE}
...
```{r loading weather data, echo = FALSE, warning = FALSE, message = FALSE}
...
<!--
```{r ueli, echo = FALSE, warning = FALSE, message = FALSE}
ueli <- filter(wildschwein, TierID == "1")
sabine <- filter(wildschwein, TierID == "2")
nicole <- filter(wildschwein, TierID == "5")
