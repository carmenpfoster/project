...
Looking at each plot from every wild boar, the plots represent how different the movement from each wild boar is. For example, “Franz” moves in summer more compared to the other seasons. “Caroline” moves a lot in almost every season. It also shows that there are wildboars that were not tracked in every season. Also, the plot shows in general that in summer and autumn there is more movement than in other seasons.
